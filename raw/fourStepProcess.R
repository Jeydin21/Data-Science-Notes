...
# For all people in the control group, where GroupNumeric=0, the red group below will = 0, and we will be left with the green group (mu.control * 1)
# For all people in the control group, where GroupNumeric=1, the green group below will = 0, and we will be left with the red group (mu.incentive * 1)
...
# the difference between you and an average person.
